 ...
 *
 * Disassembly of DSDT.aml, Fri Aug 24 13:58:30 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000A5C9 (42441)
...
DefinitionBlock ("", "DSDT", 1, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    Name (DPPL, 0x8000)
    OperationRegion (GNVS, SystemMemory, 0xBAFBEA18, 0x0203)
    ...
    OperationRegion (OGNS, SystemMemory, 0xBAFBCF98, 0x39)
    ...
    Scope (\)
    {
        OperationRegion (COMP, SystemMemory, 0xBAFBEC98, 0x0200)
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        Method (_Q11, 0, NotSerialized)  // _Qxx: EC Query
        {
            ...
            Else
            {
                Local0 = BRTS
                Local0 += 0x02
                ^^^IGPU.AINT (One, DerefOf (PLVL [Local0]))
            }
