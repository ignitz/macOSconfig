 ...
 *
 * Disassembly of DSDT.aml, Fri Aug 24 13:57:03 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000A524 (42276)
...
DefinitionBlock ("", "DSDT", 1, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    Name (DPPL, 0x8000)
    OperationRegion (GNVS, SystemMemory, 0xBAFBEA18, 0x00000203)
    ...
    OperationRegion (OGNS, SystemMemory, 0xBAFBCF98, 0x00000039)
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Device (MSS0)
                {
                    Name (_HID, EisaId ("SYN2B04"))  // _HID: Hardware ID
                ...
                Device (MSS3)
                {
                    Name (_HID, EisaId ("ETD0615"))  // _HID: Hardware ID
    ...
    Method (_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        If ((Arg0 == 0x03))
        {
            ...
            Else
            {
                \_SB.PCI0.LPCB.EC0.UWAK = Zero
            }

            If ((\_SB.PCI0.LPCB.EC0.AASD != Zero))
            {
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        ElseIf (((\_SB.PCI0.LPCB.EC0.WLEX == One) & (\_SB.PCI0.LPCB.EC0.WLAT == One)))
        {
            GP55 = One
        }
        Else
        ...
        ElseIf (((\_SB.PCI0.LPCB.EC0.BTEX == One) & (\_SB.PCI0.LPCB.EC0.BTAT == One)))
        {
            B_ON ()
        }
        Else
        ...
        If ((Arg0 == 0x03))
        {
            P8XH (0x04, 0xE3, Zero)
            P8XH (0x04, 0xE3, One)
            If ((\_SB.PCI0.LPCB.EC0.AAEW == Zero))
            {
                \_SB.PCI0.LPCB.EC0.AAST = Zero
            }
    ...
    Scope (_SB.PCI0)
    {
        Method (_INI, 0, NotSerialized)  // _INI: Initialize
        {
            ...
            If ((OSYS != 0x07DC))
            {
                ...
                PLVL [0x10] = BL14
                PLVL [0x11] = BL15
                ^LPCB.EC0.VPC0.TBSL [Zero] = BL00
                ^LPCB.EC0.VPC0.TBSL [One] = BL01
                ^LPCB.EC0.VPC0.TBSL [0x02] = BL02
                ^LPCB.EC0.VPC0.TBSL [0x03] = BL03
                ^LPCB.EC0.VPC0.TBSL [0x04] = BL04
                ^LPCB.EC0.VPC0.TBSL [0x05] = BL05
                ^LPCB.EC0.VPC0.TBSL [0x06] = BL06
                ^LPCB.EC0.VPC0.TBSL [0x07] = BL07
                ^LPCB.EC0.VPC0.TBSL [0x08] = BL08
                ^LPCB.EC0.VPC0.TBSL [0x09] = BL09
                ^LPCB.EC0.VPC0.TBSL [0x0A] = BL10
                ^LPCB.EC0.VPC0.TBSL [0x0B] = BL11
                ^LPCB.EC0.VPC0.TBSL [0x0C] = BL12
                ^LPCB.EC0.VPC0.TBSL [0x0D] = BL13
                ^LPCB.EC0.VPC0.TBSL [0x0E] = BL14
                ^LPCB.EC0.VPC0.TBSL [0x0F] = BL15
            }
            Else
            {
                PLV2 [Zero] = BL37
            ...
            If (((^PEG0.PEGP.GID2 == 0x0FD1) || (^PEG0.PEGP.GID2 == 0x0FD4)))
            {
                ^LPCB.EC0.VPC0.GPS1 = One
            }
                        ...
                        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
                        {
                            If ((OSYS == 0x07DC))
                            {
                                Return (Package (0x01)
                                {
                                    ...
                                    {
                                        /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                        /* 0008 */  0xA0, 0x19, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    OperationRegion (MDBG, SystemMemory, 0xBAFB9018, 0x00001004)
    ...
    Scope (_SB.PCI0)
    {
        Device (PEG0)
        {
            ...
            Device (PEGP)
            {
                ...
                OperationRegion (GPID, PCI_Config, Zero, 0x04)
    ...
    Scope (\)
    {
        OperationRegion (COMP, SystemMemory, 0xBAFBEC98, 0x00000200)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        ...
        Device (EC0)
        {
            ...
            {
                Name (ESRC, 0x05)
                If ((Match (CMFP, MEQ, DerefOf (Arg0 [Zero]), MTR, Zero, Zero) != Ones))
                {
                    Acquire (CFMX, 0xFFFF)
                    SMID = Arg0
                    SFNO = Arg1
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        Method (_Q11, 0, NotSerialized)  // _Qxx: EC Query
        {
            ...
            ElseIf (((Local0 == One) && (Local1 == Zero))){}
            Else
            {
                Local0 = BRTS
                Local0 += 0x02
                ^^^GFX0.AINT (One, DerefOf (PLVL [Local0]))
            }
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        Device (VPC0)
        {
            ...
            Method (_CFG, 0, NotSerialized)
            {
                ...
                Local0 |= Local2
                Local0 &= 0xFFFFE8FF
                If ((^^^^PEG0.PEGP.VID != 0xFFFF))
                {
                    If ((^^^^GFX0.VID == 0x8086))
                    {
                        If ((^^^^PEG0.PEGP.VID == 0x10DE))
                        {
                            Local0 |= 0x1500
                        }

                        If ((^^^^PEG0.PEGP.VID == 0x1002))
                        {
                            Local0 |= 0x1400
                        }
                    }
        ...
        Device (LAOC)
        {
            Name (_HID, "AOA2011")  // _HID: Hardware ID
            Name (_UID, Zero)  // _UID: Unique ID
